...
import { add, update } from './features/Crud/Crudslice';
function Update()
{
            ...
            <Col sm={4}>
              <Form onSubmit={handelSubmit} >
               ...
               {imageUrlInput && <img src={imageUrlInput} alt='product' style={{maxWidth:'100px',maxHeight:'100px'}}/>}
                ...
                <br />
                <button className='dasboard-button1' onClick={()=> {if(!id || !name)
    {
      return;
    }
    dispatch(update({id,name,image:imageUrlInput,price,des}));
    setId('');
    setDes('');
    setimageUrlInput('')
    setPrice('')
